      ...
      <nav className="sticky top-0 z-50 bg-background/95 backdrop-blur border-b border-border">
        <div className="container flex items-center justify-between h-16">
          <div className="flex items-center gap-2">
            <img src={APP_LOGO} alt="CriaNet" className="w-8 h-8" />
            <span className="font-bold text-lg">CriaNet</span>
          </div>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {projects.map((project) => (
              <Card key={project.id} className="overflow-hidden hover:border-primary/50 transition">
                <CardHeader>
      ...
      <section id="faq" className="py-20 md:py-32 bg-muted/30">
        <div className="container">
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {faqs.map((faq, idx) => (
              <Card key={idx} className="cursor-pointer hover:border-primary/50 transition">
                <CardHeader
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <img src={APP_LOGO} alt="CriaNet" className="w-6 h-6" />
                <span className="font-bold">CriaNet</span>
              </div>
